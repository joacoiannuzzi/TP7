...
/*
    ...
    public void list(){
        ...
        productStock.insert(new Lamp("ABCDE", "lowEffi", 15, 30));
        productStock.insert(new Lamp("ADEJF", "medEffi", 17, 7));
        productStock.insert(new Lamp("DEFDD", "highEffi", 20, 24));
    ...
    public void treeTest(){
        ...
        searchBinaryTree.insert(new Lamp("ABCDE", "lowEffi", 15, 30));
        searchBinaryTree.insert(new Lamp("ADEJF", "medEffi", 17, 7));
        searchBinaryTree.insert(new Lamp("DEFDD", "highEffi", 20, 24));
    ...
    public void importTest(){
        StockList productStock = new StockList();
        productStock.insert(new Lamp("ABCDE", "lowEffi", 15, 30));
        productStock.insert(new Lamp("ABERE", "dEffi", 8, 7));
        productStock.insert(new Lamp("SAPEE", "oP_Effi", 17, 7));
        productStock.insert(new Lamp("DEFDD", "highEffi", 20, 24));
        productStock.insert(new Lamp("ADEJF", "medEffi", 7, 7));
